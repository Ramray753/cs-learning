...
0000000000001060 <_start>:
    ...
    1078:	48 8d 3d e5 00 00 00 	lea    0xe5(%rip),%rdi        # 1164 <main>
...
0000000000001152 <sumstore>:
    1152:	f3 0f 1e fa          	endbr64 
    1156:	53                   	push   %rbx
    1157:	48 89 d3             	mov    %rdx,%rbx
    115a:	e8 ea ff ff ff       	call   1149 <plus>
    115f:	48 89 03             	mov    %rax,(%rbx)
    1162:	5b                   	pop    %rbx
    1163:	c3                   	ret    
...
0000000000001164 <main>:
    ...
    1173:	00 00 
    1175:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    117a:	31 c0                	xor    %eax,%eax
    117c:	48 89 e2             	mov    %rsp,%rdx
    117f:	be c8 00 00 00       	mov    $0xc8,%esi
    1184:	bf 64 00 00 00       	mov    $0x64,%edi
    1189:	e8 c4 ff ff ff       	call   1152 <sumstore>
    118e:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1193:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    119a:	00 00 
    119c:	75 0a                	jne    11a8 <main+0x44>
    119e:	b8 00 00 00 00       	mov    $0x0,%eax
    11a3:	48 83 c4 18          	add    $0x18,%rsp
    11a7:	c3                   	ret    
    11a8:	e8 a3 fe ff ff       	call   1050 <__stack_chk_fail@plt>
