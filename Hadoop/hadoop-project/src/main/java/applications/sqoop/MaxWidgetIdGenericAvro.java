...
public class MaxWidgetIdGenericAvro extends Configured implements Tool {
    ...
    public static class MaxWidgetMapper extends Mapper<AvroKey<GenericRecord>, NullWritable, AvroKey<Long>, AvroValue<GenericRecord>> {
        ...
        protected void cleanup(Context context) throws IOException, InterruptedException {
            context.write(new AvroKey<>(0L), new AvroValue<>(maxWidget));
        }
    }

    public static class MaxWidgetReducer extends Reducer<AvroKey<Long>, AvroValue<GenericRecord>, AvroKey<GenericRecord>, NullWritable> {
        ...
        protected void reduce(AvroKey<Long> key, Iterable<AvroValue<GenericRecord>> values, Context context) throws IOException, InterruptedException {
            ...
            for (AvroValue<GenericRecord> value : values) {
                ...
                if (maxWidget == null || (Integer) record.get("id") > (Integer) maxWidget.get("id")) {
